import { ActivityIndicator, ColorValue, StatusBar, StyleSheet, Text, TextStyle, View, ViewStyle, useWindowDimensions } from 'react-native'
...
const PrincipalLoader = ({ text, color }: props) => {
    ...
    const styles = StyleSheet.create({
        container: { flex: 1, backgroundColor: 'white', alignContent: 'center', justifyContent: 'center', width: width, height: "100%" },
