...
const PaymentIsago: FC<COMPONENT_TYPE> = (props) => {
    const { navigation } = props

    return (
        <ScreenPaymentContainer title='Paiement facture' payment_logo={images.edm} payment_name='ISAGO' navigation={navigation}>
            <View style={styles.payment_container}>
                {/* Numéro du compteur */}
                <View style={styles.input_title_container}>
                    <Text style={styles.title}>Numéro du compteur</Text>
                    <TextInput style={styles.input} />
                </View>
                {/* Montant */}
                <View style={styles.input_title_container}>
                    <Text style={styles.title}>Formule</Text>
                    <TextInput style={styles.input} />
                </View>
