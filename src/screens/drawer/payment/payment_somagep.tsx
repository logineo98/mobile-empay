...
const PaymentSomagep: FC<COMPONENT_TYPE> = (props) => {
    const { navigation } = props

    return (
        <ScreenPaymentContainer title='Paiement facture' payment_logo={images.somagep} payment_name='SOMAGEP' navigation={navigation}>
