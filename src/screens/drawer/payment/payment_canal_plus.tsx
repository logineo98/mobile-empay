...
const PaymentCanalPlus: FC<COMPONENT_TYPE> = (props) => {
    ...
    return (
        <ScreenPaymentContainer title='Paiement facture' payment_logo={images.canal_plus} payment_name='Canal+' navigation={navigation}>
            <View style={styles.payment_container}>
                {/* Numéro de réabonnement */}
                <View style={styles.input_title_container}>
                    <Text style={styles.title}>Numéro de réabonnement</Text>
